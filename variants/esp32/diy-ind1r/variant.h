...
#define LORA_BUSY 26  // BUSY for SX1262/SX1268
...
#define LORA_RXEN 32 // Input - RF switch RX control, connecting external MCU IO, valid in high level
...
#define PIN_ETHERNET_SS ETH_CS_PIN